...
public class DrumKit extends MouseAdapter {
    ...
    private void getGoing() throws MalformedURLException {
   	 ...
   	 JFrame KitBuild = new JFrame();
   	 KitBuild.show();
   	 KitBuild.setSize(800, 800);
   	 KitBuild.setTitle("Drum Kit Mk. III");
   	 JPanel Snare = new JPanel();
   	 KitBuild.add(Snare);
   	 String SnareObj = "Snaredrum.jpeg";
   	drumLabelWithImage = createLabelImage(SnareObj);
   	 Snare.add(drumLabelWithImage);
   	 KitBuild.setLayout(new GridLayout());
   	 KitBuild.pack();
